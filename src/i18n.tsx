...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'login.errBackend': 'Could not reach the Qrip backend — it may still be starting up, or antivirus may have blocked it',
    ...
    'dl.retry': '↻ Retry',
    'dl.clearCompleted': '✕ Clear',
    'dl.deleteFilesToo': 'Delete files too',
    ...
    'set.templateEmpty': 'Template must contain at least one token',
    'set.preview': 'Preview:',
    'set.artwork': 'Artwork',
  ...
  zh: {
    ...
    'login.errBackend': '无法连接 Qrip 后端 — 可能仍在启动中，或被杀毒软件拦截',
    ...
    'dl.completed': '已完成',
    'dl.retry': '↻ 重试',
    'dl.clearCompleted': '✕ 清空',
    'dl.deleteFilesToo': '同时删除文件',
    'dl.pausedLabel': '⏸ 已暂停',
    'dl.pause': '⏸ 暂停',
    'dl.resume': '▶ 继续',
    'dl.delete': '✕ 删除',
    ...
    'set.templateEmpty': '模板必须包含至少一个占位符',
    'set.preview': '预览：',
    'set.artwork': '封面',
