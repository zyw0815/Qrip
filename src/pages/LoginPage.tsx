        ...
        {method === 'email' && (
          <div className="flex flex-col gap-2.5 animate-fade-in">
            <input
              ...
              className="w-full h-[42px] bg-bg-input border border-border rounded-lg px-3 text-sm text-text-primary placeholder:text-text-muted outline-none focus:border-purple transition"
            />
            <input
              type="password"
              value={password}
            ...
            <button
              ...
              className="w-full h-[42px] bg-purple text-white rounded-lg text-sm font-medium hover:bg-[#6d28d9] transition disabled:opacity-50"
            >
        ...
        {method === 'token' && (
          <div className="flex flex-col gap-2.5 animate-fade-in">
            <textarea
              ...
              className="w-full h-20 bg-bg-input border border-border rounded-lg px-3 py-2.5 text-sm text-text-primary placeholder:text-text-muted outline-none focus:border-purple transition resize-none"
            />
            <button
